    ...
    return _then(_value.copyWith(
      ...
      address: freezed == address
          ...
          : address // ignore: cast_nullable_to_non_nullable
              as String?,
      isEmailVerify: freezed == isEmailVerify
...
class _$ProfileImpl implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(id: $id, name: $name, email: $email, phone: $phone, address: $address, isEmailVerify: $isEmailVerify, gender: $gender, genderCode: $genderCode, photo: $photo, joinDate: $joinDate)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, name, email, phone, address,
      isEmailVerify, gender, genderCode, photo, joinDate);
...
abstract class _Profile implements Profile {
  const factory _Profile(
      ...
      final String? genderCode,
      final String? photo,
      final String? joinDate}) = _$ProfileImpl;
