                    ...
                    child: Row(
                      ...
                      children: [
                          ...
                          child: GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                  border: Border.all(color: const Color.fromRGBO(238, 240, 244, 1), width: 2),
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Text(
                                    "Pencarian",
                                    style: TextStyle(fontSize: 16, color: Colors.black, fontWeight: FontWeight.w700, fontFamily: 'Rubik'),
                                  )
                                ],
                              ),
                            ),
                        ...
                        GestureDetector(
                          ...
                          child: buildImageSizeIcon(context, changeUrlImage(s.perusahaan?['logoPerusahaan'] ?? 'wwwroot/Images/CompanyLogo/logo_hora.png')),
                        ),
                      ],
                    )),
                Padding(
                  ...
                  child: Row(
                    children: [
                      TextButton(
                          style: ButtonStyle(
                              backgroundColor: MaterialStatePropertyAll(hadirHighlight ? colorBlueOpacity : Colors.white),
                      ...
                      TextButton(
                          style: ButtonStyle(
                              backgroundColor: MaterialStatePropertyAll(izinHighlight ? colorBlueOpacity : Colors.white),
                              padding: MaterialStatePropertyAll(EdgeInsets.all(5))),
                          onPressed: () {
                            setState(() {
                              izinHighlight = true;
                        ...
                        child: GestureDetector(
                          onTap: () async {
                            await showDatePicker(
                                    ...
                                    context: context,
                                    initialDate: DateFormat("yyyy-MM-dd hh:mm:ss").parse(s.currentDate!),
                                ...
                                .then((value) {
                              setState(() {
                                curentDate = DateTime.parse(value.toString()).day.toString().padLeft(2, "0") +
                                    "/" +
                                    DateTime.parse(value.toString()).month.toString().padLeft(2, "0") +
                                    "/" +
                                    DateTime.parse(value.toString()).year.toString();
                              });
            ...
            floatingActionButton: hadirHighlight
                ? Container(
                    ...
                    child: FloatingActionButton.extended(
                      ...
                      backgroundColor: s.isPresentHadir! ? Colors.grey.shade400 : colorBluePrimary2,
                    ),
                  )
                : Container(
                    // padding: EdgeInsets.only(bottom: 20),
                    child: Column(
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: FittedBox(
                            child: FloatingActionButton(
                              ...
                              backgroundColor: s.isPresentIzin! ? Colors.grey.shade400 : colorBlueOpacity2,
                              child: Icon(
                        ...
                        FloatingActionButton(
                          heroTag: "btn3",
                          backgroundColor: s.isPresentIzin! ? Colors.grey.shade400 : colorBlackPrimary,
                          child: Icon(
                            FeatherIcons.camera,
