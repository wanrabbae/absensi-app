...
class _ApiService implements ApiService {
  ...
  @override
  Future<List<Agenda>> getAgenda({required String idPerusahaan}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'idperusahaan': idPerusahaan};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _result =
        await _dio.fetch<List<dynamic>>(_setStreamType<List<Agenda>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    var value = _result.data!
        .map((dynamic i) => Agenda.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
  ...
  Future<HttpResponse<dynamic>> submitAgenda({
    required String idKaryawan,
    required AgendaMutable request,
    CancelToken? cancelToken,
  }) async {
    final _extra = <String, dynamic>{};
