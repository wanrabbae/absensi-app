...
mixin _$Profile {
  ...
  String? get perusahaan => throw _privateConstructorUsedError;
  @JsonKey(name: 'idperusahaan')
  String? get perusahaanId => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      phone: freezed == phone
          ...
          : phone // ignore: cast_nullable_to_non_nullable
              as String?,
      perusahaan: freezed == perusahaan
          ? _value.perusahaan
          : perusahaan // ignore: cast_nullable_to_non_nullable
              as String?,
      perusahaanId: freezed == perusahaanId
          ? _value.perusahaanId
          : perusahaanId // ignore: cast_nullable_to_non_nullable
              as String?,
...
class _$ProfileImpl implements _Profile {
  const _$ProfileImpl(
      ...
      @JsonKey(name: 'idkaryawan') this.idkaryawan,
  ...
  @override
  String toString() {
    return 'Profile(id: $id, name: $name, liked: $liked, email: $email, phone: $phone, perusahaan: $perusahaan, perusahaanId: $perusahaanId, longitude: $longitude, latitude: $latitude, address: $address, photo: $photo, joinDate: $joinDate, status: $status, fcmToken: $fcmToken, idkaryawan: $idkaryawan, gender: $gender)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.perusahaanId, perusahaanId) ||
                other.perusahaanId == perusahaanId) &&
...
abstract class _Profile implements Profile {
  const factory _Profile(
      ...
      @JsonKey(name: 'idkaryawan') final String? idkaryawan,
      @JsonKey(name: 'gender') final String? gender}) = _$ProfileImpl;
  ...
  @override
  @JsonKey(name: 'namaPerusahaan')
  String? get perusahaan;
  @override
  @JsonKey(name: 'idperusahaan')
  String? get perusahaanId;
  @override
  @JsonKey(name: 'alamatLongtitude')
