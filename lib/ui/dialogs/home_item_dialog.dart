...
class _HomeItemDialogState extends State<HomeItemDialog> with AfterLayoutMixin<HomeItemDialog> {
  ...
  FutureOr<void> afterFirstLayout(BuildContext context) {
    context.read<LiveLocationCubit>().storeFetch(
          ...
          children: [
            ...
            Center(
              child: CircleAvatar(
                ...
                child: widget.userModel?.fotoKaryawan == null
                    ? Text(
                        widget.userModel?.firstCharName ?? '-',
                      )
                    : null,
                backgroundImage: widget.userModel?.fotoKaryawan != null ? NetworkImage(widget.userModel?.fotoUrl ?? '') : null,
              ),
            ),
            Positioned(
              bottom: 0,
